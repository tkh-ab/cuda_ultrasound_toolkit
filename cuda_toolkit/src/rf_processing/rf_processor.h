...
public:
    ...
    bool init(uint2 rf_raw_dim, uint3 dec_data_dim, EncodingMatrix readi_ordering = EncodingMatrix::HADAMARD);
    bool deinit();
...
private:
    ...
    bool _dims_changed(uint2 rf_raw_dim, uint3 dec_data_dim, EncodingMatrix readi_order) const
    {
